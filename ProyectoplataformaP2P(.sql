...
CREATE TABLE IF NOT EXISTS detalle_orden(
    ...
    REFERENCES productos (id_producto)  ON DELETE CASCADE;
     ...
     -- Primero crear la tabla Bitacora_vendedor_log para guardar log de los triggers
...
-- -- Primero crear la tabla Bitacora_usuario_log para guardar log de los triggers de la tabla uauario
